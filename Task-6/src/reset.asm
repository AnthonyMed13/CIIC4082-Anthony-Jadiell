...
.importzp clock,clock_frames, clock_hundreds1, clock_hundreds2, clock_tens1, clock_tens2, clock_units1, clock_units2, clock_posx, total_time, clock_posy, end_count
.segment "CODE"
.import main
